...
This only works with Latex/PDF output. To use it in R Markdown documents, we need to load the upgreek package in the YAML header, using `header-includes: -\usepackageupgreek`
